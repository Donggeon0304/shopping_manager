...
<html lang="ko">
 ...
 <main>
    ...
    <li>※ 아이디</li>
    <li>
    <input type="text" class="join_in1" name="user_id"> <input type="button" value="중복확인" class="join_btn1">
    </li>
    <li>※ 비밀번호</li>
    <li>
    ...
    <li>※ 이메일</li>
    <li>
    <input type="text" class="join_in1" name="user_email"> <input type="button" value="이메일 인증" class="join_btn1"> ※ 입력하신 이메일을 확인해 주세요.
    </li>
    <li>※ 인증번호</li>
    <li>
