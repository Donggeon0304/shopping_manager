...
<section style="width: 1100px; height: auto; margin: 0 auto; margin-top: 30px;">
    ...
    <textarea placeholder="이용약관에 대한 내용을 입력하세요" style="width: 100%; height: 100px; resize: none;" name="use_terms">${terms.use_terms}</textarea>
    <input type="button" value="이용약관 수정" id="terms_btn1" title="이용약관 수정" class="btn_button" style="position: relative; left: 100%; margin-left: -100px;">
</section>
<section style="width: 1100px; height: auto; margin: 0 auto; margin-top: 30px;">
    <p style="font-size: 15px;font-weight: bolder; margin-bottom: 10px;">■ 개인정보 수집 및 이용</p>
    <textarea placeholder="개인정보 수집 및 이용" style="width: 100%; height: 100px; resize: none;" name="personal_terms">${terms.personal_terms}</textarea>
    <input type="button" value="개인정보 약관 수정" id="terms_btn2" title="개인정보 약관 수정" class="btn_button" style="position: relative; left: 100%; margin-left: -100px;">
</section>
</form>
</main>
<%@include file="../copyright.jsp" %>
</body>
<script src="../resources/js/admin/shop_member_list.js?v=<%= System.currentTimeMillis() %>"></script>
</html>