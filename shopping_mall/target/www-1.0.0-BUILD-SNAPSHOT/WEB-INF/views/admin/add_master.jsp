    ...
    <section class="admin_bgcolor_add">
        <div class="admin_login_add">
            <ul>
                ...
                <li>
                <input type="text" class="add_input1" id="aid" name="aid" placeholder="생성할 관리자 아이디를 입력하세요" maxlength="20">
                <button type="button"  class="btn_button" id="idck">중복체크</button>
                </li>
                <li>
                    <input type="text" class="add_input1" id="apass" name="apass" placeholder="접속할 패스워드를 입력하세요" maxlength="16">
                    <input type="text" class="add_input1" id="apass2" placeholder="동일한 패스워드를 입력하세요">
                </li>
                <li class="font_color1">관리자 기본정보 입력</li>
                <li>
                    <input type="text" class="add_input1" id="aname" name="aname" placeholder="담당자 이름을 입력하세요">
                </li>
                <li>
                <input type="text" class="add_input1 emails" id="aemail" name="aemail" placeholder="담당자 이메일을 입력하세요">
                </li>
                <li class="font_color1">
                <input type="text" class="add_input1 hp1" name="atel" placeholder="HP" maxlength="3">
                -
                ...
                <li>
                    <select class="add_select1" id="ateam" name="ateam">
                    ...
                    <select class="add_select1" id="aposition" name="aposition">
